# Taken from https://github.com/StableCoder/cmake-scripts
#
...
function(target_code_coverage TARGET_NAME)
  ...
  if(target_type STREQUAL "EXECUTABLE")
    if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang"
      ...
      # As custom targets with COMMAND are always considered out of date, we
      # want the merged/all targets to depend on this, so that we don't
      # necessarily re-run the executable every time, only at a minimum to
    ...
    elseif(CMAKE_C_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES
      ...
      add_custom_command(
        ...
        COMMAND
          ...
          ${CMAKE_SOURCE_DIR} --capture ${EXTERNAL_OPTION} ${IGNORE_ERRORS}
          --output-file ${COVERAGE_INFO} ${target_code_coverage_LCOV_OPTIONS}
  ...
  elseif(CMAKE_C_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES
    ...
    add_custom_command(
      ...
      COMMAND
        ...
        ${CMAKE_BINARY_DIR} --capture ${IGNORE_ERRORS} --output-file
        ${COVERAGE_INFO}
      COMMAND ${EXCLUDE_COMMAND}
