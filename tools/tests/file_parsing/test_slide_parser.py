...
FILE_WITH_TWO_TASKS_AND_DOCUMENTATION = (
    FILE_WITH_TWO_TASKS + "\n## Documentation\n" + DOCUMENTATION
)
...
class ParserTest(TestCase):
    ...
    def test_get_tasks_from_slides_with_documentation(self) -> None:
        ...
        self.assertEqual(len(tasks), 2)
        self._check_task(
            tasks[0], Task("Task 1 - Do stuff", TASK_1_DESCRIPTION, DOCUMENTATION)
        )
        self._check_task(
            tasks[1], Task("Task 2 - Do more", TASK_2_DESCRIPTION, DOCUMENTATION)
        )
